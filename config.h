...
static const int smartgaps_fact          = 300;   /* gap factor when there is only one client; 0 = no gaps, 3 = 3x outer gaps */
...
static char selbgcolor[]                 = "#4a7680";
static char selbordercolor[]             = "#4a7680";
static char selfloatcolor[]              = "#4a7680";
...
static char titleselbordercolor[]        = "#4a7680";
static char titleselfloatcolor[]         = "#4a7680";
...
static char tagsselbordercolor[]         = "#4a7680";
static char tagsselfloatcolor[]          = "#4a7680";

static char hidnormfgcolor[]             = "#4a7680";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_s,          spawn,                  SHCMD("bw-dmenu") },
	...
	{ MODKEY|ShiftMask,             XK_F2,         spawn,                  SHCMD("brightnessctl set 1%-; touch /tmp/dwm_backlight_show; ( sleep 2 && rm -f /tmp/dwm_backlight_show && kill -45 $(pidof dwmblocks) ) & kill -45 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,             XK_F3,         spawn,                  SHCMD("brightnessctl set +1%; touch /tmp/dwm_backlight_show; ( sleep 2 && rm -f /tmp/dwm_backlight_show && kill -45 $(pidof dwmblocks) ) & kill -45 $(pidof dwmblocks)") },
	{ MODKEY,                       XK_F6,         spawn,                  SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,                       XK_F7,         spawn,                  SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -1000; touch /tmp/dwm_volume_show; ( sleep 2 && rm -f /tmp/dwm_volume_show && kill -44 $(pidof dwmblocks) ) & kill -44 $(pidof dwmblocks)") },
